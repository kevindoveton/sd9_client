...
angular.module("DigiControl", [ "DigiControl.controllers", "DigiControl.filters", "DigiControl.services", "DigiControl.directives", "ui.router", "btford.socket-io", "rzModule", "ionic" ]).config(function($stateProvider, $urlRouterProvider) {
    $stateProvider.state({
        name: "home",
        url: "/home",
